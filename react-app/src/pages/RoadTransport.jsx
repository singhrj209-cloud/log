...
@import url('https://fonts.googleapis.com/css2?family=Manrope:wght@400;600;700;800&family=Sora:wght@500;700;800&display=swap');
    ...
    .service-card{position:relative;background:linear-gradient(180deg,#ffffff,#f8fafc);border:1px solid rgba(14,165,233,.75);box-shadow:0 0 0 1px rgba(56,189,248,.3),0 0 18px rgba(56,189,248,.2),inset 0 0 12px rgba(56,189,248,.12);transition:.35s}
    .service-card::after{content:"";position:absolute;inset:0;border-radius:1rem;background:linear-gradient(120deg,rgba(56,189,248,.08),rgba(14,165,233,0));opacity:0;transition:.35s}
    .service-card:hover{transform:translateY(-8px) scale(1.01);box-shadow:0 0 0 1px rgba(34,211,238,.6),0 0 28px rgba(34,211,238,.34),inset 0 0 18px rgba(34,211,238,.12)}
    .service-card:hover::after{opacity:1}
    .service-icon{background:linear-gradient(135deg,#e0f2fe,#f0f9ff);border:1px solid #7dd3fc;color:#0284c7}
    ...
    .feature-item{background:linear-gradient(135deg,#e0f2fe,#f0f9ff);border:1px solid #bfdbfe;border-radius:1rem;padding:1.5rem;transition:.4s}
    .feature-item:hover{transform:translateY(-8px);border-color:#0ea5e9;box-shadow:0 16px 32px rgba(14,165,233,.25)}
    .feature-icon{width:56px;height:56px;background:linear-gradient(135deg,#0ea5e9,#06b6d4);border-radius:14px;display:flex;align-items:center;justify-content:center;color:#fff;font-size:1.75rem;margin-bottom:1rem}
    ...
    .hero-copy .hero-badge{display:block;text-align:center}.hero-copy h1,.hero-copy p{margin-inline:auto}.hero-actions{justify-content:center}.workflow::before{display:none}.flow-grid{grid-template-columns:1fr}.flow-step{text-align:center;padding:1.5rem}.flow-num{position:relative;transform:none;top:auto;left:auto}}
...
<header class="fixed w-full z-50 glass-nav">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
      <div class="grid md:grid-cols-[1fr_1.2fr] gap-8 items-center">
        <div class="hero-copy text-white">
          <span class="hero-badge mb-3 inline-block">Road Transport</span>
          <h1 class="text-4xl sm:text-5xl lg:text-6xl font-extrabold mb-5 leading-[1.08] tracking-tight max-w-xl">Direct road freight across the UK and Europe.</h1>
          <p class="text-base sm:text-lg text-slate-300 mb-8 max-w-lg leading-relaxed">Dedicated fleet, proactive routing, and on-time handover for pallet, parcel, and full-load road shipments.</p>
          <div class="hero-actions flex flex-wrap gap-4">
            ...
            <a href="/get-quote" class="hero-ghost text-white px-6 py-3 rounded-sm font-bold text-sm transition">Get Quote</a>
          </div>
        </div>
  ...
  <section id="services" class="py-24 section-shell">
    <div class="orb o1"></div>
    <div class="orb o2"></div>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="text-center mb-14 animate-on-scroll">
        <span class="hero-badge">Road Logistics</span>
        <h2 class="text-4xl sm:text-5xl font-extrabold mt-4">End-to-End Road Transport</h2>
        <p class="text-slate-600 mt-4 max-w-3xl mx-auto">Flexible road coverage for full truckload, LTL, and time-critical dispatch with live tracking.</p>
      </div>
      <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        <article class="service-card rounded-2xl p-6 animate-on-scroll">
          <div class="service-icon w-14 h-14 rounded-2xl flex items-center justify-center text-2xl mb-4"><i class="fas fa-truck-moving"></i></div>
          <h3 class="text-lg font-bold mb-2">Full Truckload</h3>
          <p class="text-slate-600 text-sm">Dedicated vehicles with optimized routing and scheduled dispatch.</p>
        </article>
        <article class="service-card rounded-2xl p-6 animate-on-scroll" style="transition-delay:.08s">
          <div class="service-icon w-14 h-14 rounded-2xl flex items-center justify-center text-2xl mb-4"><i class="fas fa-boxes-stacked"></i></div>
          <h3 class="text-lg font-bold mb-2">LTL Consolidation</h3>
          <p class="text-slate-600 text-sm">Shared loads with cost efficiency and delivery transparency.</p>
        </article>
        <article class="service-card rounded-2xl p-6 animate-on-scroll" style="transition-delay:.16s">
          <div class="service-icon w-14 h-14 rounded-2xl flex items-center justify-center text-2xl mb-4"><i class="fas fa-stopwatch"></i></div>
          <h3 class="text-lg font-bold mb-2">Express Dispatch</h3>
          <p class="text-slate-600 text-sm">Same-day and next-day routes for urgent freight.</p>
        </article>
      </div>
    </div>
  </section>
  ...
  <section class="py-24">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="text-center mb-14 animate-on-scroll">
        <h2 class="text-4xl sm:text-5xl font-extrabold">How Road Transport Works</h2>
        <p class="text-slate-600 mt-4 max-w-3xl mx-auto">Simple, predictable steps from booking to delivery.</p>
      </div>
      <div class="workflow animate-on-scroll">
        <div class="flow-grid">
          <div class="flow-step">
            ...
            <h4>Book & Plan</h4>
            <p>Share route details and cargo specs. We confirm the optimal plan.</p>
          </div>
          <div class="flow-step">
            <div class="flow-num">2</div>
            <h4>Pickup</h4>
            <p>Drivers verify, load, and secure cargo with compliance checks.</p>
          </div>
          <div class="flow-step">
            <div class="flow-num">3</div>
            <h4>In Transit</h4>
            <p>Live tracking updates and proactive notifications.</p>
          </div>
          <div class="flow-step">
            <div class="flow-num">4</div>
            <h4>Delivery</h4>
            <p>Proof of delivery and final confirmation shared instantly.</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="py-24 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="text-center mb-14 animate-on-scroll">
        <h2 class="text-4xl sm:text-5xl font-extrabold">Road Transport Advantages</h2>
        <p class="text-slate-600 mt-4 max-w-3xl mx-auto">High-frequency lanes, precise ETAs, and tailored load planning.</p>
      </div>
      <div class="feature-grid">
        <article class="feature-item animate-on-scroll">
          <div class="feature-icon"><i class="fas fa-route"></i></div>
          <h4 class="font-bold text-lg mb-2">Smart Routing</h4>
          <p class="text-slate-600 text-sm">We optimize routes using traffic and delivery windows.</p>
        </article>
        <article class="feature-item animate-on-scroll">
          <div class="feature-icon"><i class="fas fa-shield-check"></i></div>
          <h4 class="font-bold text-lg mb-2">Safe Handling</h4>
          <p class="text-slate-600 text-sm">Secure loading practices and insured shipments.</p>
        </article>
        <article class="feature-item animate-on-scroll">
          <div class="feature-icon"><i class="fas fa-satellite-dish"></i></div>
          <h4 class="font-bold text-lg mb-2">Live Visibility</h4>
          <p class="text-slate-600 text-sm">Continuous updates and alerts for every shipment.</p>
        </article>
      </div>
    </div>
  </section>
  ...
  <section class="py-24 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="text-center mb-12 animate-on-scroll"><h2 class="text-4xl font-extrabold">What Our Clients Say</h2><p class="text-slate-600 mt-3">Reviews from our customers.</p></div>
      <div class="test-wrap">
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="cta rounded-3xl p-8 sm:p-14 text-white text-center animate-on-scroll">
        <div class="relative z-10">
          ...
          <h2 class="text-3xl sm:text-5xl font-extrabold mb-5">Ready To Move Your Road Freight?</h2>
          <p class="text-base sm:text-xl text-cyan-100 mb-9 max-w-3xl mx-auto">Request a quote and get a tailored road transport plan with clear ETAs.</p>
          <div class="flex flex-col sm:flex-row justify-center gap-4">
            <a href="/get-quote" class="bg-white text-sky-700 px-10 py-4 rounded-xl font-bold text-lg hover:bg-slate-100">Get Quote</a>
  ...
  <footer class="bg-slate-950 text-white pt-20 pb-10">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
        ...
        <div><h4 class="text-lg font-bold mb-6 border-b border-slate-800 pb-2">Quick Links</h4><ul class="space-y-4 text-slate-400"><li><a href="/">Home</a></li><li><a href="/about">About</a></li><li><a href="/services">Services</a></li><li><a href="/shipment-tracking">Track</a></li></ul></div>
        <div><h4 class="text-lg font-bold mb-6 border-b border-slate-800 pb-2">Road Services</h4><ul class="space-y-4 text-slate-400"><li>Full Truckload</li><li>LTL Consolidation</li><li>Express Dispatch</li><li>Cross-Dock</li></ul></div>
