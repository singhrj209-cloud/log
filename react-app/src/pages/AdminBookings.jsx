...
import { initAdminCommon, initBookings } from '../utils/adminPanel';
  ...
  <div class='app-shell'>
    <aside class='sidebar' id='sidebar'>
      ...
      <nav class='space-y-2'>
        ...
        <a class='nav-item nav-active' href='/admin/bookings'><i class='fa-solid fa-file-signature'></i>Bookings</a>
    ...
    <main class='px-6 py-8 lg:px-10'>
      <div class='topbar mb-8'>
        <div class='flex items-center gap-3'>
          ...
          <div>
            <p class='text-sm uppercase tracking-[.3em] text-slate-400'>Bookings</p>
            <h1 class='text-3xl font-bold'>Get Quote Requests</h1>
          </div>
        </div>
      </div>
      ...
      <section class='card'>
        <div class='flex items-center justify-between mb-4'>
          <div>
            ...
            <p class='text-sm text-slate-500'>Requests submitted from get-quote.html</p>
          </div>
          <span class='text-xs px-3 py-1 rounded-full bg-sky-100 text-sky-700 font-semibold' id='bookingCount'>0 Records</span>
        </div>
          ...
          <table>
            ...
            <tbody id='bookingsBody'>
              <tr>
                ...
                <td>10 Mar</td>
                <td class='space-x-2'>
                  <button class='px-3 py-2 text-xs font-semibold rounded-lg border border-slate-200 hover:border-sky-300'>Add to Shipment</button>
                  <button class='px-3 py-2 text-xs font-semibold rounded-lg border border-red-200 text-red-600 hover:border-red-300'>Delete</button>
                </td>
              </tr>
            </tbody>
          </table>
