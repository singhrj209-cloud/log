...
@import url('https://fonts.googleapis.com/css2?family=Manrope:wght@400;600;700;800&family=Sora:wght@500;700;800&display=swap');
    ...
    .card{background:#fff;border:1px solid rgba(14,165,233,.3);transition:.35s}.card:hover{transform:translateY(-6px);box-shadow:0 18px 30px -22px rgba(14,165,233,.55)}
    .input{width:100%;border:1px solid #cbd5e1;border-radius:.8rem;padding:.8rem .95rem}.input:focus{outline:none;border-color:#0ea5e9;box-shadow:0 0 0 3px rgba(14,165,233,.18)}
    .btn{background:linear-gradient(135deg,#0ea5e9,#0284c7);color:#fff;transition:.35s}.btn:hover{transform:translateY(-3px)}
...
<header class="fixed w-full z-50 glass-nav">
  ...
  <section class='py-24'>
    <div class='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-7'>
      <div class='space-y-5'>
        <div class='card rounded-2xl p-6 animate-on-scroll'><h3 class='text-2xl font-extrabold mb-4'>Contact Details</h3><ul class='space-y-3 text-slate-600'><li><i class='fa-solid fa-phone text-sky-600 mr-2'></i><strong>Phone:</strong> +44 7438 282122</li><li><i class='fa-solid fa-envelope text-sky-600 mr-2'></i><strong>Email:</strong> info@singhrjtransport.com</li><li><i class='fa-solid fa-location-dot text-sky-600 mr-2'></i><strong>Office:</strong> 60 Applecroft road, Luton (LU2 8BD), UK</li></ul></div>
        <div class='card rounded-2xl p-6 animate-on-scroll'><h3 class='text-2xl font-extrabold mb-4'>Business Hours</h3><ul class='space-y-2 text-slate-600'><li><strong>Monday - Friday:</strong> 8:00 AM - 8:00 PM</li><li><strong>Saturday:</strong> 9:00 AM - 4:00 PM</li><li><strong>Sunday:</strong> Closed (urgent support on request)</li></ul></div>
      </div>

      <div class='card rounded-2xl p-6 animate-on-scroll'>
        <h3 class='text-2xl font-extrabold mb-4'>Send Us a Message</h3>
        <form class='grid gap-4'>
          ...
          <textarea class='input min-h-[130px]' placeholder='How can we help you?' required></textarea>
          <button class='btn rounded-xl py-3 font-bold text-lg' type='submit'>Submit Contact Request</button>
        </form>
      </div>
    </div>
  </section>
  ...
  <section class='pb-24'>
    <div class='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
      <div class='card rounded-2xl overflow-hidden animate-on-scroll'>
        <iframe loading='lazy' allowfullscreen src='https://www.google.com/maps?q=Luton%20LU2%208BD&output=embed'></iframe>
      </div>
    </div>
  </section>
