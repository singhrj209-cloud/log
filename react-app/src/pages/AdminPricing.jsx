...
import { initAdminCommon, initPricing } from '../utils/adminPanel';
...
@import url('https://fonts.googleapis.com/css2?family=Space+Grotesk:wght@500;600;700&family=Plus+Jakarta+Sans:wght@400;500;600;700&display=swap');
    ...
    input{width:100%;border:1px solid var(--line);border-radius:.8rem;padding:.7rem .9rem;font-size:.9rem;background:#fff}
  ...
  <div class='app-shell'>
    <aside class='sidebar' id='sidebar'>
      ...
      <nav class='space-y-2'>
        ...
        <a class='nav-item nav-active' href='/admin/pricing'><i class='fa-solid fa-tags'></i>Pricing Plan</a>
    ...
    <main class='px-6 py-8 lg:px-10'>
      <div class='topbar mb-8'>
        <div class='flex items-center gap-3'>
          ...
          <div>
            <p class='text-sm uppercase tracking-[.3em] text-slate-400'>Pricing Plan</p>
            <h1 class='text-3xl font-bold'>Quote Pricing</h1>
          </div>
        </div>
        <div class='flex items-center gap-3 bg-white px-4 py-2 rounded-full border border-slate-200'>
          ...
          <p class='text-sm font-semibold'>Last updated: <span id='pricingUpdated'>-</span></p>
        </div>
      </div>

      <section class='card'>
        <form id='pricingForm' class='grid gap-6'>
          <div class='grid md:grid-cols-3 gap-5'>
            <div>
              <label>Base Price</label>
              <input id='basePrice' type='number' step='0.01' placeholder='32.00'>
            </div>
            <div>
              <label>Default Per Kg</label>
              <input id='defaultPerKg' type='number' step='0.01' placeholder='1.40'>
            </div>
            <div>
              <label>Express Multiplier</label>
              <input id='expressMultiplier' type='number' step='0.01' placeholder='1.40'>
            </div>
          </div>

          <div class='grid md:grid-cols-2 gap-6'>
            <div class='border border-slate-200 rounded-2xl p-4'>
              <p class='font-bold mb-3'>Document</p>
              <div class='grid md:grid-cols-2 gap-4'>
                <div>
                  <label>Factor</label>
                  <input id='docFactor' type='number' step='0.01'>
                </div>
                <div>
                  <label>Per Kg</label>
                  <input id='docPerKg' type='number' step='0.01'>
                </div>
              </div>
            </div>

            <div class='border border-slate-200 rounded-2xl p-4'>
              <p class='font-bold mb-3'>Box</p>
              <div class='grid md:grid-cols-2 gap-4'>
                <div>
                  <label>Factor</label>
                  <input id='boxFactor' type='number' step='0.01'>
                </div>
                <div>
                  <label>Per Kg</label>
                  <input id='boxPerKg' type='number' step='0.01'>
                </div>
              </div>
            </div>

            <div class='border border-slate-200 rounded-2xl p-4'>
              <p class='font-bold mb-3'>Pallet</p>
              <div class='grid md:grid-cols-2 gap-4'>
                <div>
                  <label>Factor</label>
                  <input id='palletFactor' type='number' step='0.01'>
                </div>
                <div>
                  <label>Per Kg</label>
                  <input id='palletPerKg' type='number' step='0.01'>
                </div>
              </div>
            </div>

            <div class='border border-slate-200 rounded-2xl p-4'>
              <p class='font-bold mb-3'>Fragile Goods</p>
              <div class='grid md:grid-cols-2 gap-4'>
                <div>
                  <label>Factor</label>
                  <input id='fragileFactor' type='number' step='0.01'>
                </div>
                <div>
                  <label>Per Kg</label>
                  <input id='fragilePerKg' type='number' step='0.01'>
                </div>
              </div>
            </div>
          </div>

          <button class='bg-slate-900 text-white font-semibold px-6 py-3 rounded-lg w-fit'>Save Pricing</button>
        </form>
      </section>
    </main>
  </div>
