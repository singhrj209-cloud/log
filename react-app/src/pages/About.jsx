...
@import url('https://fonts.googleapis.com/css2?family=Manrope:wght@400;600;700;800&family=Sora:wght@500;700;800&display=swap');
    ...
    .hero-truck{filter:drop-shadow(0 30px 35px rgba(2,6,23,.6))}
    ...
    .card-neon{background:linear-gradient(180deg,#ffffff,#f8fafc);border:1px solid rgba(14,165,233,.75);box-shadow:0 0 0 1px rgba(56,189,248,.3),0 0 18px rgba(56,189,248,.2),inset 0 0 12px rgba(56,189,248,.12)}
    .card-neon:hover{transform:translateY(-8px);transition:.3s;box-shadow:0 0 0 1px rgba(34,211,238,.6),0 0 28px rgba(34,211,238,.34),inset 0 0 18px rgba(34,211,238,.12)}
    .value-chip{background:#e0f2fe;border:1px solid #7dd3fc;color:#075985}
    .dark-panel{background:linear-gradient(150deg,#020617,#082f49 70%,#0ea5e9);color:#fff}
    .team-card img{height:220px;object-fit:cover}    .test-wrap{overflow:hidden}
    ...
    .hero-copy .hero-badge{display:block;text-align:center}.hero-copy h1,.hero-copy p{margin-inline:auto}.hero-truck{max-width:300px;margin-inline:auto}}
...
<header class="fixed w-full z-50 glass-nav">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid lg:grid-cols-2 gap-8 items-start">
        <div class="animate-on-scroll">
          <h2 class="text-4xl font-extrabold mb-5">Our Story</h2>
          <p class="text-slate-600 mb-4">SinghRj Transport began as a regional transport provider and grew into a road-transport specialist trusted by ecommerce, retail, and industrial clients.</p>
          <p class="text-slate-600 mb-6">Our focus has always been the same: safe movement, on-time delivery, and transparent customer communication.</p>
          <div class="grid grid-cols-2 gap-4">
            <div class="card-neon rounded-xl p-4"><p class="text-3xl font-black text-sky-600">15+</p><p class="text-sm font-semibold">Years of Experience</p></div>
            <div class="card-neon rounded-xl p-4"><p class="text-3xl font-black text-sky-600">120+</p><p class="text-sm font-semibold">Network Routes</p></div>
            <div class="card-neon rounded-xl p-4"><p class="text-3xl font-black text-sky-600">24/7</p><p class="text-sm font-semibold">Operations Support</p></div>
            <div class="card-neon rounded-xl p-4"><p class="text-3xl font-black text-sky-600">98.6%</p><p class="text-sm font-semibold">On-Time KPI</p></div>
          </div>
        </div>
        <div class="dark-panel rounded-2xl p-8 animate-on-scroll">
          <h3 class="text-2xl font-extrabold mb-4">Vision & Mission</h3>
          <p class="text-sky-100 mb-4"><strong>Mission:</strong> Deliver reliable, technology-enabled logistics with measurable service quality.</p>
          <p class="text-sky-100"><strong>Vision:</strong> Be the most trusted road-transport growth partner across domestic freight networks.</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="py-24 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="text-center mb-14 animate-on-scroll">
        <h2 class="text-4xl font-extrabold">Logistics Network & Company Values</h2>
        <p class="text-slate-600 mt-3">Strategic coverage + disciplined culture powers our execution quality.</p>
      </div>
      <div class="grid lg:grid-cols-2 gap-8">
        <div class="card-neon rounded-2xl p-8 animate-on-scroll">
          <h3 class="text-2xl font-bold mb-4">Logistics Network</h3>
          <ul class="space-y-3 text-slate-600">
            <li><i class="fa-solid fa-check text-sky-500 mr-2"></i>UK-wide route coverage with major city hubs</li>
            <li><i class="fa-solid fa-check text-sky-500 mr-2"></i>Integrated road transport and route coverage</li>
            <li><i class="fa-solid fa-check text-sky-500 mr-2"></i>Smart routing and tracking visibility</li>
            <li><i class="fa-solid fa-check text-sky-500 mr-2"></i>Scalable support for enterprise clients</li>
          </ul>
        </div>
        <div class="card-neon rounded-2xl p-8 animate-on-scroll" style="transition-delay:.1s">
          <h3 class="text-2xl font-bold mb-4">Company Values</h3>
          <div class="flex flex-wrap gap-3">
            <span class="value-chip px-4 py-2 rounded-full font-semibold">Safety First</span>
            <span class="value-chip px-4 py-2 rounded-full font-semibold">Customer Commitment</span>
            <span class="value-chip px-4 py-2 rounded-full font-semibold">Operational Excellence</span>
            <span class="value-chip px-4 py-2 rounded-full font-semibold">Integrity</span>
            <span class="value-chip px-4 py-2 rounded-full font-semibold">Continuous Innovation</span>
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="py-24 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="text-center mb-14 animate-on-scroll">
        <h2 class="text-4xl font-extrabold">Certifications & Achievements</h2>
        <p class="text-slate-600 mt-3">Recognized for quality, compliance, and service reliability.</p>
      </div>
      <div class="grid lg:grid-cols-2 gap-8">
        <div class="card-neon rounded-2xl p-8 animate-on-scroll">
          <h3 class="text-2xl font-bold mb-4">Certifications</h3>
          <ul class="space-y-3 text-slate-600">
            <li><i class="fa-solid fa-certificate text-sky-500 mr-2"></i>ISO-aligned quality processes</li>
            <li><i class="fa-solid fa-certificate text-sky-500 mr-2"></i>Freight safety protocol compliance</li>
            <li><i class="fa-solid fa-certificate text-sky-500 mr-2"></i>Insured cargo handling framework</li>
          </ul>
        </div>
        <div class="card-neon rounded-2xl p-8 animate-on-scroll" style="transition-delay:.1s">
          <h3 class="text-2xl font-bold mb-4">Our Achievements</h3>
          <ul class="space-y-3 text-slate-600">
            <li><i class="fa-solid fa-trophy text-sky-500 mr-2"></i>98.6% annual on-time delivery score</li>
            <li><i class="fa-solid fa-trophy text-sky-500 mr-2"></i>High retention among B2B shipping accounts</li>
            <li><i class="fa-solid fa-trophy text-sky-500 mr-2"></i>Expanded route and warehouse footprint year-on-year</li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <footer class="bg-slate-950 text-white pt-20 pb-10">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
        ...
        <div><h4 class="text-lg font-bold mb-6 border-b border-slate-800 pb-2">Quick Links</h4><ul class="space-y-4 text-slate-400"><li><a href="/">Home</a></li><li><a href="/about">About</a></li><li><a href="index.html#services">Services</a></li><li><a href="index.html#coverage">Coverage</a></li></ul></div>
        <div><h4 class="text-lg font-bold mb-6 border-b border-slate-800 pb-2">Core Values</h4><ul class="space-y-4 text-slate-400"><li>Safety</li><li>Integrity</li><li>Reliability</li><li>Innovation</li></ul></div>
